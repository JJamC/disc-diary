...
import { patchPost, deletePostsByUser, fetchPosts, fetchComments, postComment } from "../models/posts";
...
export async function getComments(req: Request<{ post_id: number }>, res: Response, next: NextFunction) {
...
export async function createComment(
  req: Request<{ post_id: number}, {}, {body: string, author_id: number}>,
  res: Response,
  next: NextFunction
) {
    const { post_id } = req.params;
